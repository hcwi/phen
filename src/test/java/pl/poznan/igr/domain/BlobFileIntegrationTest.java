...
@Transactional
@Configurable
public class BlobFileIntegrationTest {
	...
	@Autowired
    BlobFileDataOnDemand dod;

	@Test
    public void testCountBlobFiles() {
	...
	@Test
    public void testFindAllBlobFiles() {
        Assert.assertNotNull("Data on demand for 'BlobFile' failed to initialize correctly", dod.getRandomBlobFile());
        long count = BlobFile.countBlobFiles();
	...
	@Test
    public void testFindBlobFileEntries() {
        Assert.assertNotNull("Data on demand for 'BlobFile' failed to initialize correctly", dod.getRandomBlobFile());
        long count = BlobFile.countBlobFiles();
