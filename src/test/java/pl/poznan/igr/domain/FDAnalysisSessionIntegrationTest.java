...
@Transactional
@Configurable
public class FDAnalysisSessionIntegrationTest {
    ...
    public void testCountStatsSessions() {
        ...
        long count = FDAnalysisSession.countStatsSessions();
    ...
    public void testFindStatsSession() {
        FDAnalysisSession obj = dod.getRandomStatsSession();
        ...
        obj = FDAnalysisSession.findStatsSession(id);
    ...
    public void testFindAllStatsSessions() {
        ...
        List<FDAnalysisSession> result = FDAnalysisSession.findAllStatsSessions();
    ...
    public void testFindStatsSessionEntries() {
        ...
        List<FDAnalysisSession> result = FDAnalysisSession.findStatsSessionEntries(firstResult, maxResults);
    ...
    public void testMergeUpdate() {
        ...
        boolean modified =  dod.modifyStatsSession(obj);
        Integer currentVersion = obj.getVersion();
        FDAnalysisSession merged = obj.merge();
        obj.flush();
    ...
    public void testPersist() {
        Assert.assertNotNull("Data on demand for 'StatsSession' failed to initialize correctly", dod.getRandomStatsSession());
        FDAnalysisSession obj = dod.getNewTransientStatsSession(Integer.MAX_VALUE);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'StatsSession' with identifier '" + id + "'", FDAnalysisSession.findStatsSession(id));
    }
}
